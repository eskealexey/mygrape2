"""
Django settings for mygrape2 project.
...
if SpravgrapeConfig.name == 'spravgrape':
    CKEDITOR_5_FILE_STORAGE = "spravgrape.storage.CustomStorage" # optional
CKEDITOR_5_CONFIGS = {
    'default': {
    ...
    'extends': {
        ...
        'table': {
            ...
            'tableProperties': {
                'borderColors': [ [ 'rgba(0, 0, 0, 0.1)', '#000000', '#ffffff' ] ],
                'backgroundColors': [ [ 'rgba(0, 0, 0, 0.1)', '#000000', '#ffffff' ] ],
            },
            'tableCellProperties': {
                'borderColors': [ [ 'rgba(0, 0, 0, 0.1)', '#000000', '#ffffff' ] ],
                'backgroundColors': [ [ 'rgba(0, 0, 0, 0.1)', '#000000', '#ffffff' ] ],
